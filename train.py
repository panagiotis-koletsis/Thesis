...
#testing 
# parser.add_argument('--dset_id', required=False, type=int, default= 44126 )
# parser.add_argument('--task', required=False, type=str,choices = ['binary','multiclass','regression'], default = 'binary')

#parser.add_argument('--dset_id', required=True, type=int)
parser.add_argument('--dset_id', required=False, type=int, default= 44025 )
parser.add_argument('--vision_dset', action = 'store_true')
#parser.add_argument('--task', required=True, type=str,choices = ['binary','multiclass','regression'])
parser.add_argument('--task', required=False, type=str,choices = ['binary','multiclass','regression'], default = 'regression')
...
#cat_dims -> number of categorical columns , cat_idxs which columns are categorical ,con_idxs which columns are numerical
...
#        print(x_categ.shape, x_categ.shape,y_gts.shape, cat_mask.shape, con_mask.shape)

        # We are converting the data to embeddings in the next step
        _ , x_categ_enc, x_cont_enc = embed_data_mask(x_categ, x_cont, cat_mask, con_mask,model,vision_dset)   
#        print(x_categ_enc, x_cont_enc)
        #mpainei sto farword tou rowcol pou sto farword tou attention
